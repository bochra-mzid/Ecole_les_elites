...
import Table from "../../components/TableauEleves/TableauEleves";
...
function Eleves() {
  ...
  const handleOnchange = (e) => {
    localStorage.setItem("id_c", e.target.value)
            ...
            <GridItem xs={12} sm={12} md={12}>
              <Card>
                <CardHeader color="primary">
                  <h4 className={classes.cardTitleWhite}>التصرف في التلاميذ</h4>
